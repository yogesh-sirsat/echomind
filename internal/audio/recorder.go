...
func NewRecorder(sampleRate uint32) (*Recorder, error) {
...
func (r *Recorder) Save(path string, format string) (string, error) {
	...
	// For now, we only support WAV directly. MP3/FLAC would require more libraries.
	// The path should already have the correct extension.
